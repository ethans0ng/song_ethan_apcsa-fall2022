...
public class PictureTester
{
  ...
  public static void testEncodeDecode()
  {
    Picture swan = new Picture("swan.jpg");
    swan.explore();
    swan.encode(new Picture("msg.jpg"));
    swan.decode().explore();
  }
  public static void testEncodeDecodeFib()
  {
    Picture swan = new Picture("beach.jpg");
    swan.explore();
    Picture x =  new Picture("apple_icon.jpg");
//    x.edgeDetection(150);
    swan.encodeFib(x);
    swan.explore();
    swan.decodeFib().explore();
  }
  ...
  {
    Picture swan = new Picture("swan.jpg");
    System.out.print(swan.findClosestFib(400));
  }
